...
int64 nChainStartTime = 1502464971;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in NewCoin
    bool fStrictPayToScriptHash = true; // Always active in NewCoin
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CBigNum vector NewCoin empty mapBlockIndex NewCoin NewCoin";
        CTransaction txNew;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        assert(block.hashMerkleRoot == uint256("0x72ac95ce9761a2d16c148b28f3019c856865a199d65ea701cb1d1a41bb743b71"));
